...
job_name = "SSD_{}".format(resize)  #SSD_300x300
# The name of the model. Modify it if you want.
model_name = "VGG_VOC2007_{}".format(job_name)  #VGG_VOC2007_SSD_300x300
...
output_result_dir = "../detection_results/{}".format(job_name)
...
with open(job_file, 'w') as f:
  f.write('cd {}\n'.format(caffe_root))
  f.write('../../caffe-ssd/build/tools/caffe train \\\n')
  f.write('--solver="{}" \\\n'.format(solver_file))
